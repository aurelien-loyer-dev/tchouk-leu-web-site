...
export function WhitesSharkPage() {
  return (
    <section className="min-h-screen pt-32 pb-20 px-6 bg-gradient-to-b from-violet-300/60 via-violet-100/50 to-background dark:from-violet-950/35 dark:via-background dark:to-background text-foreground">
