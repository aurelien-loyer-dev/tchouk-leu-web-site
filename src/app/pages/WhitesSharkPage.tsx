...
export function WhitesSharkPage() {
  return (
    <section className="min-h-screen pt-32 pb-20 px-6 bg-gradient-to-b from-violet-100/70 via-background to-background dark:from-violet-950/35 dark:via-background dark:to-background text-foreground">
      <div className="max-w-4xl mx-auto text-center">
        <motion.div
          initial={{ opacity: 0, y: 24 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.6 }}
          className="rounded-3xl border border-violet-200/80 dark:border-violet-400/30 bg-white/85 dark:bg-background/70 p-10 md:p-14 backdrop-blur-sm"
        >
          <img
